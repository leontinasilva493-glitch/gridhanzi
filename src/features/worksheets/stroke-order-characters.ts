...
> & {
  hskNote: string;
  seo: Omit<StrokeOrderCharacter["seo"], "h1"> & { h1?: string };
};
...
const batchGuideSeo: Record<string, StrokeOrderCharacter["seo"]> = {
  ...
  "经": { title: "经 (jīng) Stroke Order, Meaning & Common Words", h1: "How to Write 经 (jīng): Stroke Order and Common Words", description: "Learn how to write 经 (jīng) through 已经, 经常, 经过 and 经验. See its 8 strokes, 纟 + ∁6 structure and example sentences." },
