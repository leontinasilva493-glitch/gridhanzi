...
export interface StrokeOrderTrendContext {
  title: string;
  summary: string;
  href: string;
  linkLabel: string;
...
export interface StrokeOrderCharacter {
  ...
  trendContext?: StrokeOrderTrendContext;
...
const strokeOrderCharacterEntries: StrokeOrderCharacter[] = [
  {
    ...
    seo: {
      title: "爱 (ài) Stroke Order, Meaning & Examples",
      h1: "How to Write 爱 (ài): Stroke Order, Meaning & Examples",
      description:
        "Learn how to write 爱 (ài), meaning “to love” or “like.” Follow its 10 strokes and practise common words, graded sentences and printable grids.",
    },
  },
  {
    character: "年",
    ...
    publicationStatus: "complete",
    seo: {
      title: "年 (nián) Stroke Order, Meaning & Examples",
      h1: "How to Write 年 (nián): Stroke Order, Meaning & Examples",
      description:
        "Learn how to write 年 (nián), meaning “year.” Follow its 6 strokes and practise calendar words such as 今年, 明年 and 去年.",
    },
  },
  {
    character: "佛",
    ...
    publicationStatus: "complete",
    seo: {
      title: "佛 (fó/fú) Stroke Order, Meaning & Readings",
      h1: "How to Write 佛 (fó/fú): Stroke Order and Readings",
      description:
        "Learn how to write 佛 and distinguish fó in Buddhist vocabulary from fú in 仿佛. See its 7 strokes, components, example words and sentences.",
    },
  },
];
...
strokeOrderCharacterEntries.push(
  {
    ...
    commonMistake: "Do not confuse the small right-side 勺 with a separate character or let its dot drift beyond the right edge.", confusableCharacter: { character: "白", guidance: "白 is the full left component of 的, but 的 adds the compact 勺 shape on its right." }, relatedCharacters: ["我", "你"], publicationStatus: "complete", seo: { title: "的 (de) Stroke Order, Meaning & Grammar", h1: "How to Write 的 (de): Stroke Order, Meaning & Usage", description: "Learn how to write 的 (de), the common possessive and descriptive particle. See its 8 strokes, neutral-tone usage, example words, sentences, and worksheet practice." },
  },
  {
    ...
    commonMistake: "Do not add a hook or a second line: 一 is only one horizontal stroke.", confusableCharacter: { character: "二", guidance: "二 has two separate horizontal strokes, while 一 has only one." }, relatedCharacters: ["人", "年"], publicationStatus: "complete", seo: { title: "一 (yī) Stroke Order, Meaning & Tone Changes", h1: "How to Write 一 (yī): Stroke Order and Tone Changes", description: "Learn how to write 一 (yī), meaning “one.” Follow its single stroke and understand when yī changes to yí or yì in common words and sentences." },
  },
  {
    ...
    commonMistake: "Do not flatten the lower section into a row of horizontals; keep the final foot extending to the right.", confusableCharacter: { character: "早", guidance: "Both begin with 日, but 早 has 十 below while 是 has a longer stepped lower section." }, relatedCharacters: ["在", "的"], publicationStatus: "complete", seo: { title: "是 (shì) Stroke Order, Meaning & Usage", h1: "How to Write 是 (shì): Stroke Order, Meaning & Usage", description: "Learn how to write 是 (shì), meaning “to be” or “correct.” See its 9 strokes and learn identity, question and negation patterns with examples." },
  },
  {
    ...
    commonMistake: "Do not write 土 too high; it belongs below the open upper strokes and needs a clear bottom horizontal.", confusableCharacter: { character: "左", guidance: "左 has 工 at the bottom, while 在 has 土 with a shorter upper horizontal and longer base." }, relatedCharacters: ["是", "学"], publicationStatus: "complete", seo: { title: "在 (zài) Stroke Order, Meaning & Grammar", h1: "How to Write 在 (zài): Location and Ongoing Actions", description: "Learn how to write 在 (zài) and use it for location and ongoing actions. Follow its 6 strokes and practise common grammar patterns and sentences." },
  },
  {
    ...
    commonMistake: "Do not join the two strokes into one long shape; the second stroke begins separately.", confusableCharacter: { character: "子", guidance: "子 has additional horizontal and lower strokes, while 了 has only the hook stroke and one separate curve." }, relatedCharacters: ["来", "去"], publicationStatus: "complete", seo: { title: "了 (le) Stroke Order, Meaning & Grammar", h1: "How to Write 了 (le): Stroke Order and Two Core Uses", description: "Learn how to write 了 (le) and use it for completed actions and changes of state. See its 2 strokes, example sentences and common learner mistakes." },
  },
);

type BatchGuideSeed = Omit<
  StrokeOrderCharacter,
  "hsk" | "publicationStatus" | "seo"
> & {
  hskNote: string;
};

const batchGuideSeo: Record<string, StrokeOrderCharacter["seo"]> = {
  "说": { title: "说 (shuō) Stroke Order, Meaning & Readings", h1: "How to Write 说 (shuō): Stroke Order, Usage & Readings", description: "Learn how to write 说 (shuō), meaning “to say” or “speak.” See its 9 strokes, everyday speech patterns and the alternate shuì reading in 说服." },
  "学": { title: "学 (xué) Stroke Order, Meaning & Examples", h1: "How to Write 学 (xué): Stroke Order, Meaning & Word Family", description: "Learn how to write 学 (xué), meaning “learn” or “study.” Explore its structure and practise useful words including 学生, 学校 and 学习." },
  "经": { title: "经 (jīng) Stroke Order, Meaning & Common Words", h1: "How to Write 经 (jīng): Stroke Order and Common Words", description: "Learn how to write 经 (jīng) through 已经, 经常, 经过 and 经验. See its 8 strokes, 纟 + 𢀖 structure and example sentences." },
  "体": { title: "体 (tǐ) Stroke Order, Meaning & Common Words", h1: "How to Write 体 (tǐ): Stroke Order and Common Words", description: "Learn how to write 体 (tǐ) through 身体, 体育, 体重 and 整体. Follow its 7 strokes and compare its 亻 + 本 structure with 休." },
  "议": { title: "议 (yì) Stroke Order, Meaning & Common Words", h1: "How to Write 议 (yì): Stroke Order and Discussion Words", description: "Learn how to write 议 (yì) through 会议, 建议, 议论 and 议题. See its 5 strokes, 讠 + 义 structure and meeting-related examples." },
  "我": { title: "我 (wǒ) Stroke Order, Meaning & Examples", h1: "How to Write 我 (wǒ): Stroke Order, Meaning & Examples", description: "Learn how to write 我 (wǒ), meaning “I” or “me.” Follow its 7 strokes and practise first-person phrases, sentences and printable writing grids." },
  "你": { title: "你 (nǐ) Stroke Order, Meaning & Examples", h1: "How to Write 你 (nǐ): Stroke Order, Meaning & Examples", description: "Learn how to write 你 (nǐ), meaning “you.” See its 7-stroke structure and practise 你好, 你们 and other useful phrases and sentences." },
  "人": { title: "人 (rén) Stroke Order, Meaning & Examples", h1: "How to Write 人 (rén): Stroke Order, Meaning & Examples", description: "Learn how to write 人 (rén), meaning “person” or “people.” Follow its 2 strokes, compare 人 with 入, and practise common words and sentences." },
  "来": { title: "来 (lái) Stroke Order, Meaning & Direction", h1: "How to Write 来 (lái): Stroke Order and Directional Use", description: "Learn how to write 来 (lái), meaning “to come.” Follow its 7 strokes and understand movement toward a speaker or reference point by comparing 来 and 去." },
  "去": { title: "去 (qù) Stroke Order, Meaning & Direction", h1: "How to Write 去 (qù): Stroke Order and Directional Use", description: "Learn how to write 去 (qù), meaning “to go.” See its 5 strokes and understand movement away from a reference point through words and sentences." },
  "牛": { title: "牛 (niú) Stroke Order, Meaning & Slang Use", h1: "How to Write 牛 (niú): Stroke Order, Meaning & Slang", description: "Learn how to write 牛 (niú), meaning cow or ox, and why it can mean “awesome” in Chinese slang. Follow its 4 strokes, common words and the 牛来 meme context." },
};
...
const batchHskCards: Record<string, StrokeOrderCharacter["hsk"]> = {
  ...
  "牛": [
    { system: "HSK 2.0", level: "Level 2", evidenceKind: "word-family", note: "Word-family anchor: 牛奶 is listed at Level 2; this is not a standalone-character level claim." },
    { system: "HSK 3.0", level: "Level 1", evidenceKind: "word-family", note: "Word-family anchor: 牛奶 is listed at Level 1; this is not a standalone-character level claim." },
    { system: "HSK 3.0", level: "Level 3", evidenceKind: "standalone", note: "Exact 牛 (niú) record is listed at Level 3." },
  ],
};
...
function publishedBatchGuide({ hskNote: _hskNote, ...entry }: BatchGuideSeed): StrokeOrderCharacter {
  ...
  const seo = batchGuideSeo[entry.character];
  if (!seo) throw new Error(`Missing character-specific SEO for ${entry.character}`);
...
strokeOrderCharacterEntries.push(
  publishedBatchGuide({
    character: "牛",
    pinyin: "niú",
    meaning: "cow; ox; impressive in slang",
    strokes: 4,
    radical: "牛",
    traditional: "牛",
    structure: "Single-component",
    learningTier: "Beginner",
    hskNote: "Standalone 牛 is HSK 3.0 Level 3; 牛奶 supplies lower-level word-family anchors.",
    importance: "牛 is a concrete animal character, a building block in everyday food vocabulary, and a common positive slang adjective.",
    components: [{ character: "牛", explanation: "The original pictographic form suggests the front of an ox or cow, with the central line and crossing strokes recalling its head and horns." }],
    readingNotes: "牛 is read niú with a rising tone. The same pronunciation is used for the animal sense and the informal meaning ‘awesome’ or ‘impressive’.",
    useNotes: "Use 牛 literally in words such as 牛奶 and 牛肉. In informal speech, 很牛 praises a person, skill, or result; it is casual and should not be treated as a formal adjective for every setting.",
    usageTitle: "From cattle to an informal compliment",
    usage: "牛 first names cattle and supports practical words for food, animals, and everyday conversation. Modern informal Chinese also uses 牛 for someone or something impressive. Context separates the literal animal from the compliment, while 吹牛 has a different meaning: to boast.",
    writingTip: "Begin with the short left-falling stroke, keep the two horizontals clearly separated, and finish with a straight central vertical that passes through them and anchors the form below.",
    examples: [
      { hanzi: "牛奶", pinyin: "niúnǎi", meaning: "milk" },
      { hanzi: "牛肉", pinyin: "niúròu", meaning: "beef" },
      { hanzi: "水牛", pinyin: "shuǐniú", meaning: "water buffalo" },
      { hanzi: "吹牛", pinyin: "chuīniú", meaning: "to boast" },
    ],
    exampleSentences: [
      { learningLabel: "Starter", hanzi: "我每天喝牛奶。", pinyin: "Wǒ měitiān hē niúnǎi.", meaning: "I drink milk every day." },
      { learningLabel: "Developing", hanzi: "这家店的牛肉面很有名。", pinyin: "Zhè jiā diàn de niúròumiàn hěn yǒumíng.", meaning: "This shop's beef noodles are well known." },
      { learningLabel: "Stretch", hanzi: "她的中文进步很快，真的很牛。", pinyin: "Tā de Zhōngwén jìnbù hěn kuài, zhēnde hěn niú.", meaning: "Her Chinese is improving quickly; that is really impressive." },
    ],
    commonMistake: "Do not shorten the final vertical or stop it at the lower horizontal; in 牛 it passes through the centre and extends below the character's main crossbar.",
    confusableCharacter: { character: "午", guidance: "牛 and 午 share similar strokes, but 牛's central vertical passes through both horizontals; 午 keeps its short upper stroke group above the longer crossbar." },
    relatedCharacters: ["来", "年"],
    trendContext: { title: "Why 牛 appears in 牛来", summary: "牛 is the calf's name and the first character of the 2026 film title 牛来. The title became an internet meme, but 牛来 is not an HSK vocabulary item or a standard two-character expression.", href: "/chinese-slang/niu-lai", linkLabel: "Read the 牛来 meme and language guide" },
  }),
);
