...
const p0TemplateDrafts: TemplateDraft[] = [
  ...
  },
  {
    ...
    seoDescription: "Practise 18 familiar Hanzi with Pinyin above each writing row, then edit the word list and download a free printable Chinese worksheet.",
...
const mvpTemplateDrafts: TemplateDraft[] = [
  ...
  },
  {
    ...
    seoDescription: "See a printable list of 100 Chinese characters with Pinyin and meanings, then open the full list as an editable Hanzi writing worksheet.",
  ...
  },
  {
    ...
    recommendedProfile: "kids",
    title: "Tian Zi Ge Beginner Worksheet",
    seoTitle: "Editable Tian Zi Ge Worksheet (18 Hanzi)",
    seoDescription: "Practise 18 beginner Chinese characters in editable Tian Zi Ge rows with Pinyin, tracing, handwriting guidance, and printable PDF output.",
    h1: "Tian Zi Ge Beginner Character Worksheet",
    chineseTitle: "\u7530\u5b57\u683c\u7ec3\u4e60\u7eb8",
    description: "Start from a Tian Zi Ge Chinese character grid, edit the starter Hanzi, and print practice paper.",
    age: "Ages 4+",
    level: "Beginner",
    category: "kids",
  ...
  },
  {
    ...
    recommendedProfile: "kids",
    title: "Mi Zi Ge Beginner Worksheet",
    seoTitle: "Editable Mi Zi Ge Worksheet (18 Hanzi)",
    seoDescription: "Practise 18 beginner Chinese characters in editable Mi Zi Ge rows with Pinyin, tracing, diagonal guides, and printable PDF output.",
    h1: "Mi Zi Ge Beginner Character Worksheet",
    chineseTitle: "\u7c73\u5b57\u683c\u7ec3\u4e60\u7eb8",
    description: "Start from Mi Zi Ge Hanzi grid paper, replace the starter characters, and print a Chinese writing grid.",
    age: "Ages 4+",
    level: "Beginner",
    category: "kids",
    words: ["\u4e00", "\u4e8c", "\u4e09", "\u5341", "\u4eba", "\u53e3", "\u65e5", "\u6708", "\u6728", "\u6c34", "\u706b", "\u5c71", "\u7530", "\u4e2d", "\u5927", "\u5c0f", "\u4e0a", "\u4e0b"],
...
const mvpTemplateGuidance: Record<string, TemplateGuidance> = {
  ...
  "blank-tianzige-grid": {
    learningGoal: "Learners begin with a square Tian Zi Ge Chinese character grid, then edit the starter list into a blank or custom handwriting worksheet.",
    teachingTip: "Use this page when the main goal is Chinese character grid control. Open the generator, delete rows for blank grid paper, or replace the starter characters with class words.",
    practiceActivity: "Students trace the starter characters once, then open the generator to replace three rows with current lesson words and print the customised Tian Zi Ge grid.",
  },
  ...
  "blank-mi-zi-ge-grid": {
    learningGoal: "Learners use Mi Zi Ge Hanzi grid paper to control stroke angle, centre balance, and character proportions before moving into free writing.",
    teachingTip: "Use this page for shape control rather than vocabulary load. Replace the starter rows with current class words or delete rows for mostly blank Hanzi grid paper.",
    practiceActivity: "Students write five simple characters on Mi Zi Ge paper, compare centre placement, and reprint the sheet with only the characters that need correction.",
  },
