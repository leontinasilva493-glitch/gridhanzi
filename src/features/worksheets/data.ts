...
const mvpTemplateDrafts: TemplateDraft[] = [
  ...
  },
  {
    ...
    seoDescription: "Print a Tian Zi Ge Chinese character grid with square guide lines, editable Hanzi practice rows, Pinyin, and handwriting PDF output.",
  ...
  },
  {
    ...
    seoDescription: "Print Mi Zi Ge Hanzi grid paper with diagonal guide lines, editable Chinese character rows, Pinyin, and handwriting PDF output.",
